        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <Rock:RockCheckBox ID="cbUserSelectable" runat="server" Label="User Selectable" Text="Yes" Help="This flag enables the note type to be selected from the note entry screen." />
